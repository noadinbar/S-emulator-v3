...
public final class DebugResponder {
     ...
     */
    public static DebugResults.Submit init(Request req) throws Exception {
        try (Response res = HttpClientUtil.runSync(req)) {
            ...
            throw new RuntimeException("DEBUG init (async) failed: HTTP " + code + " | " + body);
        }
    }
    ...
    // --------------------- Synchronous endpoints kept as-is ---------------------

    /** Single step remains synchronous. */
